...
function onLoadPage(event)
{
    ...
    {
        var label;
        var title1 = "The new save method can save some pages";
        var title2 = "that the original save method cannot save";
        var title3 = "but does not remember the last save folder";
        var title4 = "The default is use the original save method";
        var title5 = "if possible, else use the new save method";
